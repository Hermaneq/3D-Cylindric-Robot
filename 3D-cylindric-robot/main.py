...
class RobotSimulation(ShowBase):
    def __init__(self):
        ...
        self.mySound = self.loader.loadSfx("3D-cylindric-robot\images\Fail.mp3")

        self.buttonRecord = DirectButton(text="Start recording",
            scale=0.1,
        ...
        self.buttonPlay = DirectButton(text="Replay",
            scale=0.1,
        ...
        self.buttonReset = DirectButton(text="Camera Reset",
            scale=0.1,
            frameColor=(0.4, 0.6, 0.8, 1),  
        ...
        self.buttonMove = DirectButton(text="Move",
            scale=0.1,
            frameColor=(0.4, 0.6, 0.8, 1),
            frameSize=(-1, 1, -0.5, 0.5),  
            pos=(-1.21, 0, -0.7),  
        ...
        #Printing positions
        print(f" Ball position: {self.primitive.getPos()}")
        print(f" Barell position: 2 -8 6.4")
    ...
    def start_recording(self):
        if not self.recording:
            ...
            self.buttonRecord.setText("Stop recording")
            self.recording = True
            self.record = []
        else:
            ...
            self.buttonRecord.setText("Start recording")
            self.recording = False
